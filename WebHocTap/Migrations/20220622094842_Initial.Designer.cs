...
namespace WebHocTap.Migrations
{
    ...
    [Migration("20220622094842_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WebHocTap.Entity.Admin", b =>
                {
            ...
            modelBuilder.Entity("WebHocTap.Entity.AdminAccount", b =>
                {
            ...
            modelBuilder.Entity("WebHocTap.Entity.Class", b =>
                {
            ...
            modelBuilder.Entity("WebHocTap.Entity.Class_Course", b =>
                {
            ...
            modelBuilder.Entity("WebHocTap.Entity.Class_Test", b =>
                {
            ...
            modelBuilder.Entity("WebHocTap.Entity.Course", b =>
                {
            ...
            modelBuilder.Entity("WebHocTap.Entity.Document", b =>
                {
            ...
            modelBuilder.Entity("WebHocTap.Entity.Grade", b =>
                {
            ...
            modelBuilder.Entity("WebHocTap.Entity.LearningOutcome", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WebHocTap.Entity.Position", b =>
                {
            ...
            modelBuilder.Entity("WebHocTap.Entity.Student", b =>
                {
            ...
            modelBuilder.Entity("WebHocTap.Entity.Student_Test", b =>
                {
            ...
            modelBuilder.Entity("WebHocTap.Entity.StudentAccount", b =>
                {
                    b.Property<string>("userName")
                        .HasMaxLength(50)
                        .IsUnicode(false)
            ...
            modelBuilder.Entity("WebHocTap.Entity.Subject", b =>
                {
            ...
            modelBuilder.Entity("WebHocTap.Entity.Test", b =>
                {
            ...
            modelBuilder.Entity("WebHocTap.Entity.TestCategory", b =>
                {
            ...
            modelBuilder.Entity("WebHocTap.Entity.Admin", b =>
                {
                    b.HasOne("WebHocTap.Entity.Position", "Position1")
                        .WithMany("Admins")
                        .HasForeignKey("Position");

                    b.HasOne("WebHocTap.Entity.Subject", "Subject1")
                        .WithMany("Admins")
            ...
            modelBuilder.Entity("WebHocTap.Entity.AdminAccount", b =>
                {
                    b.HasOne("WebHocTap.Entity.Admin", "Admin1")
                        .WithMany("AdminAccount")
                        .HasForeignKey("Admin")
            ...
            modelBuilder.Entity("WebHocTap.Entity.Class", b =>
                {
                    b.HasOne("WebHocTap.Entity.Grade", "Grade1")
                        .WithMany("Classes")
                        .HasForeignKey("Grade");
            ...
            modelBuilder.Entity("WebHocTap.Entity.Class_Course", b =>
                {
                    b.HasOne("WebHocTap.Entity.Class", "Class1")
                        .WithMany("Class_Course")
                        .HasForeignKey("Class")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("WebHocTap.Entity.Course", "Course1")
                        .WithMany("Class_Course")
            ...
            modelBuilder.Entity("WebHocTap.Entity.Class_Test", b =>
                {
                    ...
                    b.HasOne("WebHocTap.Entity.Test", "Test1")
                        .WithMany("Class_Test")
                        .HasForeignKey("Test");
            ...
            modelBuilder.Entity("WebHocTap.Entity.LearningOutcome", b =>
                {
                    b.HasOne("WebHocTap.Entity.Student", "Student1")
                        .WithMany("LearningOutcomes")
                        .HasForeignKey("Student")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("WebHocTap.Entity.Student_Test", "Student_Test1")
                        .WithMany("LearningOutcomes")
            ...
            modelBuilder.Entity("WebHocTap.Entity.Student_Test", b =>
                {
                    b.HasOne("WebHocTap.Entity.Class_Test", "Class_Test1")
            ...
            modelBuilder.Entity("WebHocTap.Entity.Test", b =>
                {
                    b.HasOne("WebHocTap.Entity.TestCategory", "TestCategory1")
                        .WithMany("Tests")
